...
@window_cmd.command(name="list", help="List currently open windows")
def window_list_cmd() -> None:
    try:
...
@window_cmd.command(name="move", help="Move a window")
...
@window_cmd.command(name="resize", help="Resize a window")
@click.option("--target", required=True, help="Window id, title substring, or wm_class")
...
@window_cmd.command(name="minimize", help="Minimize a window")
@click.option("--target", required=True, help="Window id, title substring, or wm_class")
...
@window_cmd.command(name="maximize", help="Maximize a window")
@click.option("--target", required=True, help="Window id, title substring, or wm_class")

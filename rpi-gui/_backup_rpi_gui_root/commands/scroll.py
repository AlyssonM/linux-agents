...
from rpi_gui.modules.input import InputError, run_scroll


@click.command(help="Scroll screen up/down by steps")
...
def scroll(direction: str, steps: int, clicks_per_step: int) -> None:
    try:
